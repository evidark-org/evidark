      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          {loading ? (
            <div className="space-y-4">
              {[...Array(3)].map((_, i) => (
                <Card key={i} className="bg-background/30 border-border/50 animate-pulse">
            ...
            <Card className="bg-background/30 border-border/50">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">Silence in the Void</h3>
                <p className="text-muted-foreground">
                  No whispers have been heard yet. Be the first to break the silence.
                </p>
              </CardContent>
            </Card>
          ) : (
